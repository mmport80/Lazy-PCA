...
Elm.Forms.AnalysisForm.make = function (_elm) {
   ...
   var PortableModel = F7(function (a,b,c,d,e,f,g) {    return {endDate: a,startDate: b,ticker: c,$yield: d,source: e,frequency: f,newData: g};});
   ...
   var sendData = function (data) {
      return $Effects.task(A2($Task.andThen,A2($Signal.send,sendToPlotMailBox.address,data),function (_p9) {    return $Task.succeed(NoOp);}));
   };
   ...
   var update = F2(function (action,model) {
      ...
      {case "UpdateSource": return {ctor: "_Tuple2"
         ...
         default: var data = A2($Maybe.withDefault,model.newData,_p20._0);
