...
Elm.Forms.AnalysisForm.make = function (_elm) {
   ...
   var convertElmModelToPortableFormat = function (model) {
      return {endDate: model.endDate.value
             ...
             ,newData: A2($List.map,function (_p3) {    var _p4 = _p3;return {ctor: "_Tuple2",_0: dateToISOFormat(_p4._0),_1: _p4._1};},model.newData)};
   };
   var csvRow = A2($Json$Decode.map,
   function (_p5) {
      var _p6 = _p5;
      return {ctor: "_Tuple2",_0: A2(toDate,$Date.fromTime(0),_p6._0),_1: _p6._6};
   },
   ...
   var sendData = function (data) {
      return $Effects.task(A2($Task.andThen,A2($Signal.send,sendToPlotMailBox.address,data),function (_p7) {    return $Task.succeed(Save);}));
   };
   var sendDataToPlot = function (model) {
      ...
      function (_p8) {
         var _p9 = _p8;
         return {ctor: "_Tuple2",_0: dateToISOFormat(_p9._1),_1: _p9._2};
      },
      A2($List.filter,
      function (_p10) {
         var _p11 = _p10;
         var _p12 = _p11._1;
         return _U.cmp($Date.toTime(_p12),sd) > -1 && _U.cmp($Date.toTime(_p12),ed) < 1;
      },
      A2($List.filter,
      function (_p13) {
         var _p14 = _p13;
         return _U.eq(A2($Basics._op["%"],_p14._0,fInt),0);
      },
      A2($List.indexedMap,F2(function (i,_p15) {    var _p16 = _p15;return {ctor: "_Tuple3",_0: i,_1: _p16._0,_2: _p16._1};}),model.newData)))));
   };
   var NoOp = {ctor: "NoOp"};
   var saveData = function (model) {
      return $Effects.task(A2($Task.andThen,A2($Signal.send,saveToDBMailBox.address,model),function (_p17) {    return $Task.succeed(NoOp);}));
   };
   ...
   var update = F2(function (action,model) {
      ...
      {case "UpdateSource": return {ctor: "_Tuple2"
                                   ,_0: _U.update(model,{source: A2($Forms$Components$SelectInput.update,_p18._0,model.source)})
                                   ,_1: $Effects.none};
         case "UpdateFrequency": var model$ = _U.update(model,{frequency: A2($Forms$Components$SelectInput.update,_p18._0,model.frequency)});
           return {ctor: "_Tuple2",_0: model$,_1: sendDataToPlot(model$)};
         case "UpdateTicker": return {ctor: "_Tuple2"
                                     ,_0: _U.update(model,{ticker: A2($Forms$Components$InputField.update,_p18._0,model.ticker)})
                                     ,_1: $Effects.none};
         case "UpdateYield": return {ctor: "_Tuple2",_0: _U.update(model,{$yield: A2($Forms$Components$Yield.update,_p18._0,model.$yield)}),_1: $Effects.none};
         case "UpdateStartDate": var model$ = _U.update(model,{startDate: A2($Forms$Components$InputField.update,_p18._0,model.startDate)});
           return {ctor: "_Tuple2",_0: model$,_1: sendDataToPlot(model$)};
         case "UpdateEndDate": var model$ = _U.update(model,{endDate: A2($Forms$Components$InputField.update,_p18._0,model.endDate)});
           return {ctor: "_Tuple2",_0: model$,_1: sendDataToPlot(model$)};
         ...
         default: var pModel = convertElmModelToPortableFormat(model);
           var data = A2($Maybe.withDefault,model.newData,_p18._0);
           var onlyDates = A2($List.map,function (_p19) {    var _p20 = _p19;return _p20._0;},data);
           var maybeToDate = function (_p21) {    return A2($Date$Format.format,"%Y-%m-%d",A2($Maybe.withDefault,$Date.fromTime(0),_p21));};
...
Elm.Router.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      var _p1 = model.locationLinks;
      switch (_p1)
      {case "analysis": return A2($Html.div,
           _U.list([]),
           _U.list([A2($LocationLinks.view,A2($Signal.forwardTo,address,ChangeLocation),model.locationLinks)
                   ,A2($Forms$AnalysisForm.view,A2($Signal.forwardTo,address,Analysis),model.analysisForm)]));
         case "register": return A2($Html.div,
           _U.list([]),
           _U.list([A2($LocationLinks.view,A2($Signal.forwardTo,address,ChangeLocation),model.locationLinks)
                   ,A2($Forms$RegisterForm.view,A2($Signal.forwardTo,address,Register),model.registerForm)]));
         case "login": return A2($Html.div,
           _U.list([]),
           _U.list([A2($LocationLinks.view,A2($Signal.forwardTo,address,ChangeLocation),model.locationLinks)
                   ,A2($Forms$LoginForm.view,A2($Signal.forwardTo,address,Login),model.loginForm)]));
         default: return A2($Html.div,_U.list([]),_U.list([A2($LocationLinks.view,A2($Signal.forwardTo,address,ChangeLocation),model.locationLinks)]));}
   });
   var Model = F4(function (a,b,c,d) {    return {analysisForm: a,loginForm: b,registerForm: c,locationLinks: d};});
   var init = function () {
   ...
   var update = F2(function (action,model) {
      var _p5 = action;
      switch (_p5.ctor)
      {case "Analysis": var _p8 = _p5._0;
           var _p6 = A2($Forms$AnalysisForm.update,_p8,model.analysisForm);
           var newData = _p6._0;
           var fx = _p6._1;
           var _p7 = _p8;
           if (_p7.ctor === "Save") {
                 return {ctor: "_Tuple2",_0: _U.update(model,{analysisForm: newData}),_1: A2($Effects.map,Analysis,fx)};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{analysisForm: newData}),_1: A2($Effects.map,Analysis,fx)};
              }
         case "Register": var _p9 = A2($Forms$RegisterForm.update,_p5._0,model.registerForm);
           var newUser = _p9._0;
           var fx = _p9._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {registerForm: newUser
                  ,locationLinks: function () {
                     var _p10 = newUser.response;
                     if (_p10 === "OK") {
                           return $LocationLinks.update($LocationLinks.Analysis);
                        } else {
                           return model.locationLinks;
                        }
                  }()})
                  ,_1: A2($Effects.map,Register,fx)};
         case "Login": var _p11 = A2($Forms$LoginForm.update,_p5._0,model.loginForm);
           var newUser = _p11._0;
           var fx = _p11._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{loginForm: newUser,locationLinks: A2(forwardOnLogin,newUser.response,model.locationLinks)})
                  ,_1: A2($Effects.map,Login,fx)};
         default: var newLocation = $LocationLinks.update(_p5._0);
           var _p12 = newLocation;
           if (_p12 === "logout") {
                 return init;
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{locationLinks: newLocation}),_1: $Effects.none};
              }}
   });
