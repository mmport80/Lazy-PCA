...
Elm.Forms = Elm.Forms || {};
Elm.Forms.Components = Elm.Forms.Components || {};
Elm.Forms.Components.SelectInput = Elm.Forms.Components.SelectInput || {};
Elm.Forms.Components.SelectInput.make = function (_elm) {
   "use strict";
   _elm.Forms = _elm.Forms || {};
   _elm.Forms.Components = _elm.Forms.Components || {};
   _elm.Forms.Components.SelectInput = _elm.Forms.Components.SelectInput || {};
   if (_elm.Forms.Components.SelectInput.values) return _elm.Forms.Components.SelectInput.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.Forms.Components.SelectInput.values = {_op: _op
                                                     ,Model: Model
                                                     ,Option: Option
                                                     ,init: init
                                                     ,Enable: Enable
...
Elm.Forms = Elm.Forms || {};
Elm.Forms.Components = Elm.Forms.Components || {};
Elm.Forms.Components.InputField = Elm.Forms.Components.InputField || {};
Elm.Forms.Components.InputField.make = function (_elm) {
   "use strict";
   _elm.Forms = _elm.Forms || {};
   _elm.Forms.Components = _elm.Forms.Components || {};
   _elm.Forms.Components.InputField = _elm.Forms.Components.InputField || {};
   if (_elm.Forms.Components.InputField.values) return _elm.Forms.Components.InputField.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.Forms.Components.InputField.values = {_op: _op
                                                    ,Model: Model
                                                    ,init: init
                                                    ,Update: Update
                                                    ,Enable: Enable
...
Elm.Forms = Elm.Forms || {};
Elm.Forms.Components = Elm.Forms.Components || {};
Elm.Forms.Components.Yield = Elm.Forms.Components.Yield || {};
Elm.Forms.Components.Yield.make = function (_elm) {
   "use strict";
   _elm.Forms = _elm.Forms || {};
   _elm.Forms.Components = _elm.Forms.Components || {};
   _elm.Forms.Components.Yield = _elm.Forms.Components.Yield || {};
   if (_elm.Forms.Components.Yield.values) return _elm.Forms.Components.Yield.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.Forms.Components.Yield.values = {_op: _op,init: init,update: update,view: view};
};
Elm.Forms = Elm.Forms || {};
Elm.Forms.AnalysisForm = Elm.Forms.AnalysisForm || {};
Elm.Forms.AnalysisForm.make = function (_elm) {
   "use strict";
   _elm.Forms = _elm.Forms || {};
   _elm.Forms.AnalysisForm = _elm.Forms.AnalysisForm || {};
   if (_elm.Forms.AnalysisForm.values) return _elm.Forms.AnalysisForm.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Date = Elm.Date.make(_elm),
   ...
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Forms$Components$InputField = Elm.Forms.Components.InputField.make(_elm),
   $Forms$Components$SelectInput = Elm.Forms.Components.SelectInput.make(_elm),
   $Forms$Components$Yield = Elm.Forms.Components.Yield.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var now = A2($Signal.map,function (_p0) {    var _p1 = _p0;return _p1._0;},$Time.timestamp($Signal.constant(1)));
   var fromDateToInteger = function (d) {    return function (_p2) {    return A2($Maybe.withDefault,d,$Result.toMaybe($String.toInt(_p2)));};};
   var toDate = function (d) {    return function (_p3) {    return A2($Result.withDefault,d,$Date.fromString(_p3));};};
   var toInteger = function (d) {    return function (_p4) {    return A2($Maybe.withDefault,d,$Result.toMaybe($String.toInt(_p4)));};};
   var PortableModel = F7(function (a,b,c,d,e,f,g) {    return {endDate: a,startDate: b,ticker: c,y: d,source: e,frequency: f,newData: g};});
   var saveToDBMailBox = $Signal.mailbox(A7(PortableModel,"","","",false,"","",_U.list([{ctor: "_Tuple2",_0: "",_1: 0}])));
   var sendToPlotMailBox = $Signal.mailbox(_U.list([{ctor: "_Tuple2",_0: "",_1: 0}]));
   var dateToISOFormat = $Date$Format.format("%Y-%m-%d");
   var convertElmModelToPortableFormat = function (model) {
      return {endDate: model.endDate.value
             ,startDate: model.startDate.value
             ,ticker: model.ticker.value
             ,y: model.$yield
             ,source: model.source.value
             ,frequency: model.frequency.value
             ,newData: A2($List.map,function (_p5) {    var _p6 = _p5;return {ctor: "_Tuple2",_0: dateToISOFormat(_p6._0),_1: _p6._1};},model.newData)};
   };
   var csvRow = A2($Json$Decode.map,
   function (_p7) {
      var _p8 = _p7;
      return {ctor: "_Tuple2",_0: A2(toDate,$Date.fromTime(0),_p8._0),_1: _p8._6};
   },
   ...
   var sendData = function (data) {
      return $Effects.task(A2($Task.andThen,A2($Signal.send,sendToPlotMailBox.address,data),function (_p9) {    return $Task.succeed(Save);}));
   };
   var sendDataToPlot = function (model) {
      ...
      function (_p10) {
         var _p11 = _p10;
         return {ctor: "_Tuple2",_0: dateToISOFormat(_p11._1),_1: _p11._2};
      },
      A2($List.filter,
      function (_p12) {
         var _p13 = _p12;
         var _p14 = _p13._1;
         return _U.cmp($Date.toTime(_p14),sd) > -1 && _U.cmp($Date.toTime(_p14),ed) < 1;
      },
      A2($List.filter,
      function (_p15) {
         var _p16 = _p15;
         return _U.eq(A2($Basics._op["%"],_p16._0,fInt),0);
      },
      A2($List.indexedMap,F2(function (i,_p17) {    var _p18 = _p17;return {ctor: "_Tuple3",_0: i,_1: _p18._0,_2: _p18._1};}),model.newData)))));
   };
   var NoOp = {ctor: "NoOp"};
   var saveData = function (model) {
      return $Effects.task(A2($Task.andThen,A2($Signal.send,saveToDBMailBox.address,model),function (_p19) {    return $Task.succeed(NoOp);}));
   };
   ...
   var update = F2(function (action,model) {
      ...
      {case "UpdateSource": return {ctor: "_Tuple2"
                                   ,_0: _U.update(model,{source: A2($Forms$Components$SelectInput.update,_p20._0,model.source)})
                                   ,_1: $Effects.none};
         case "UpdateFrequency": var model$ = _U.update(model,{frequency: A2($Forms$Components$SelectInput.update,_p20._0,model.frequency)});
           return {ctor: "_Tuple2",_0: model$,_1: sendDataToPlot(model$)};
         case "UpdateTicker": return {ctor: "_Tuple2"
                                     ,_0: _U.update(model,{ticker: A2($Forms$Components$InputField.update,_p20._0,model.ticker)})
                                     ,_1: $Effects.none};
         case "UpdateYield": return {ctor: "_Tuple2",_0: _U.update(model,{$yield: A2($Forms$Components$Yield.update,_p20._0,model.$yield)}),_1: $Effects.none};
         case "UpdateStartDate": var model$ = _U.update(model,{startDate: A2($Forms$Components$InputField.update,_p20._0,model.startDate)});
           return {ctor: "_Tuple2",_0: model$,_1: sendDataToPlot(model$)};
         case "UpdateEndDate": var model$ = _U.update(model,{endDate: A2($Forms$Components$InputField.update,_p20._0,model.endDate)});
           return {ctor: "_Tuple2",_0: model$,_1: sendDataToPlot(model$)};
         case "Request": return {ctor: "_Tuple2"
                                ...
                                ,startDate: A2($Forms$Components$InputField.update,$Forms$Components$InputField.Enable,model.startDate)
                                ,endDate: A2($Forms$Components$InputField.update,$Forms$Components$InputField.Enable,model.endDate)})
                                ,_1: getData(model)};
         case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "Save": var pModel = convertElmModelToPortableFormat(model);
           return {ctor: "_Tuple2",_0: model,_1: saveData(pModel)};
         default: var pModel = convertElmModelToPortableFormat(model);
           var data = A2($Maybe.withDefault,model.newData,_p20._0);
           var onlyDates = A2($List.map,function (_p21) {    var _p22 = _p21;return _p22._0;},data);
           var maybeToDate = function (_p23) {    return A2($Date$Format.format,"%Y-%m-%d",A2($Maybe.withDefault,$Date.fromTime(0),_p23));};
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              _U.list([]),
              _U.list([A2($Forms$Components$SelectInput.view,A2($Signal.forwardTo,address,UpdateSource),model.source)
                      ,A2($Forms$Components$InputField.view,A2($Signal.forwardTo,address,UpdateTicker),model.ticker)
                      ,A2($Forms$Components$Yield.view,A2($Signal.forwardTo,address,UpdateYield),model.$yield)
                      ,$Html.text("Yield")
              ...
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.div,_U.list([]),_U.list([A2($Forms$Components$SelectInput.view,A2($Signal.forwardTo,address,UpdateFrequency),model.frequency)]))
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([$Html.text("Start Date")
                      ...
                      ,$Html.text($Basics.toString(model.plotId))
                      ,$Html.text("xoxo")]))]));
   });
   var Model = F8(function (a,b,c,d,e,f,g,h) {    return {plotId: a,source: b,ticker: c,$yield: d,newData: e,frequency: f,startDate: g,endDate: h};});
   var defaultRow = A2(F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),$Date.fromTime(0),0);
   var init = function () {
      var frequencyOptions = _U.list([A2($Forms$Components$SelectInput.Option,"1","Daily")
                                     ,A2($Forms$Components$SelectInput.Option,"5","Weekly")
                                     ,A2($Forms$Components$SelectInput.Option,"21","Monthly")
                                     ,A2($Forms$Components$SelectInput.Option,"63","Quarterly")]);
      var sourceOptions = _U.list([A2($Forms$Components$SelectInput.Option,"YAHOO","Yahoo")
                                  ,A2($Forms$Components$SelectInput.Option,"GOOG","Google")
                                  ,A2($Forms$Components$SelectInput.Option,"CBOE","Chicago Board of Options Exchange")
                                  ,A2($Forms$Components$SelectInput.Option,"SPDJ","S&P Dow Jones")]);
      return {ctor: "_Tuple2"
             ,_0: {startDate: A4($Forms$Components$InputField.init,"","Start Date","date",true)
                  ,endDate: A4($Forms$Components$InputField.init,"","End Date","date",true)
                  ,ticker: A4($Forms$Components$InputField.init,"INDEX_VIX","Ticker","text",false)
                  ,$yield: $Forms$Components$Yield.init(false)
                  ,newData: _U.list([defaultRow])
                  ,source: A3($Forms$Components$SelectInput.init,"YAHOO",sourceOptions,false)
                  ,frequency: A3($Forms$Components$SelectInput.init,"21",frequencyOptions,true)
                  ,plotId: now}
             ,_1: $Effects.none};
   }();
   return _elm.Forms.AnalysisForm.values = {_op: _op
                                           ...
                                           ,PortableModel: PortableModel
                                           ,convertElmModelToPortableFormat: convertElmModelToPortableFormat
                                           ,saveData: saveData
                                           ,saveToDBMailBox: saveToDBMailBox
                                           ,toInteger: toInteger
                                           ,toDate: toDate
...
Elm.Forms = Elm.Forms || {};
Elm.Forms.LoginForm = Elm.Forms.LoginForm || {};
Elm.Forms.LoginForm.make = function (_elm) {
   "use strict";
   _elm.Forms = _elm.Forms || {};
   _elm.Forms.LoginForm = _elm.Forms.LoginForm || {};
   if (_elm.Forms.LoginForm.values) return _elm.Forms.LoginForm.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var ResponseMessage = F2(function (a,b) {    return {response: a,token: b};});
   var NoOp = {ctor: "NoOp"};
   var sendData = function (data) {
   ...
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "UpdateUsername": return {ctor: "_Tuple2"
                                     ,_0: _U.update(model,{username: A2($Forms$Components$InputField.update,_p1._0,model.username)})
                                     ,_1: $Effects.none};
         case "UpdatePassword": return {ctor: "_Tuple2"
         ...
         default: var _p2 = _p1._0;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {password: A2($Forms$Components$InputField.update,$Forms$Components$InputField.Reset,model.password),response: _p2.response,token: _p2.token})
                  ,_1: $Effects.none};}
   });
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Forms$Components$InputField.view,A2($Signal.forwardTo,address,UpdateUsername),model.username)
              ,A2($Forms$Components$InputField.view,A2($Signal.forwardTo,address,UpdatePassword),model.password)
   ...
   var init = F2(function (username,password) {
      return {ctor: "_Tuple2"
             ,_0: {username: A4($Forms$Components$InputField.init,username,"Username","text",false)
                  ,password: A4($Forms$Components$InputField.init,password,"Password","password",false)
                  ,response: ""
                  ,token: ""}
             ,_1: $Effects.none};
   });
   var Model = F4(function (a,b,c,d) {    return {username: a,password: b,response: c,token: d};});
   return _elm.Forms.LoginForm.values = {_op: _op
                                        ,Model: Model
                                        ,init: init
...
Elm.Forms = Elm.Forms || {};
Elm.Forms.RegisterForm = Elm.Forms.RegisterForm || {};
Elm.Forms.RegisterForm.make = function (_elm) {
   "use strict";
   _elm.Forms = _elm.Forms || {};
   _elm.Forms.RegisterForm = _elm.Forms.RegisterForm || {};
   if (_elm.Forms.RegisterForm.values) return _elm.Forms.RegisterForm.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var NoOp = {ctor: "NoOp"};
   var sendData = function (data) {
      return $Effects.task(A2($Task.andThen,A2($Signal.send,registerRequestMailBox.address,data),function (_p0) {    return $Task.succeed(NoOp);}));
   };
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "UpdateFullname": return {ctor: "_Tuple2"
                                     ,_0: _U.update(model,{fullname: A2($Forms$Components$InputField.update,_p1._0,model.fullname)})
                                     ,_1: $Effects.none};
         case "UpdateUsername": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,{username: A2($Forms$Components$InputField.update,_p1._0,model.username)})
                                       ,_1: $Effects.none};
   ...
   var Request = {ctor: "Request"};
   var UpdatePassword = function (a) {    return {ctor: "UpdatePassword",_0: a};};
   var UpdateFullname = function (a) {    return {ctor: "UpdateFullname",_0: a};};
   var UpdateUsername = function (a) {    return {ctor: "UpdateUsername",_0: a};};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Forms$Components$InputField.view,A2($Signal.forwardTo,address,UpdateFullname),model.fullname)
              ,A2($Forms$Components$InputField.view,A2($Signal.forwardTo,address,UpdateUsername),model.username)
              ,A2($Forms$Components$InputField.view,A2($Signal.forwardTo,address,UpdatePassword),model.password)
   ...
   var init = F3(function (username,password,fullname) {
      return {ctor: "_Tuple2"
             ,_0: {username: A4($Forms$Components$InputField.init,username,"Username","text",false)
                  ,fullname: A4($Forms$Components$InputField.init,fullname,"Full Name","text",false)
                  ,password: A4($Forms$Components$InputField.init,password,"Password","password",false)
                  ,response: ""
                  ,token: ""}
             ,_1: $Effects.none};
   });
   var Model = F5(function (a,b,c,d,e) {    return {username: a,fullname: b,password: c,response: d,token: e};});
   return _elm.Forms.RegisterForm.values = {_op: _op
                                           ,Model: Model
                                           ,init: init
                                           ,UpdateUsername: UpdateUsername
...
Elm.Router.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Forms$AnalysisForm = Elm.Forms.AnalysisForm.make(_elm),
   $Forms$LoginForm = Elm.Forms.LoginForm.make(_elm),
   $Forms$RegisterForm = Elm.Forms.RegisterForm.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $LocationLinks = Elm.LocationLinks.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   ...
   var view = F2(function (address,model) {
      ...
      {case "analysis": return A2($Html.div,
           ...
           _U.list([A2($LocationLinks.view,A2($Signal.forwardTo,address,ChangeLocation),model.location)
                   ,A2($Forms$AnalysisForm.view,A2($Signal.forwardTo,address,Analysis),model.data)]));
         case "register": return A2($Html.div,
           _U.list([]),
           _U.list([A2($LocationLinks.view,A2($Signal.forwardTo,address,ChangeLocation),model.location)
                   ,A2($Forms$RegisterForm.view,A2($Signal.forwardTo,address,Register),model.userRegister)]));
         case "login": return A2($Html.div,
           _U.list([]),
           _U.list([A2($LocationLinks.view,A2($Signal.forwardTo,address,ChangeLocation),model.location)
                   ,A2($Forms$LoginForm.view,A2($Signal.forwardTo,address,Login),model.userLogin)]));
         default: return A2($Html.div,_U.list([]),_U.list([A2($LocationLinks.view,A2($Signal.forwardTo,address,ChangeLocation),model.location)]));}
   });
   var Model = F4(function (a,b,c,d) {    return {data: a,userLogin: b,userRegister: c,location: d};});
   var init = function () {
      var locationLinks = $LocationLinks.init("");
      var _p2 = A3($Forms$RegisterForm.init,"","","");
      var register = _p2._0;
      var registerFx = _p2._1;
      var _p3 = A2($Forms$LoginForm.init,"","");
      var login = _p3._0;
      var loginFx = _p3._1;
      var _p4 = $Forms$AnalysisForm.init;
      var analysis = _p4._0;
   ...
   var update = F2(function (action,model) {
      var _p5 = action;
      switch (_p5.ctor)
      {case "Analysis": var _p6 = A2($Forms$AnalysisForm.update,_p5._0,model.data);
           var newData = _p6._0;
           var fx = _p6._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{data: newData}),_1: A2($Effects.map,Analysis,fx)};
         case "Register": var _p7 = A2($Forms$RegisterForm.update,_p5._0,model.userRegister);
           var newUser = _p7._0;
           var fx = _p7._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  ...
                  ,_1: A2($Effects.map,Register,fx)};
         case "Login": var _p9 = A2($Forms$LoginForm.update,_p5._0,model.userLogin);
           var newUser = _p9._0;
           var fx = _p9._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{userLogin: newUser,location: A2(forwardOnLogin,newUser.response,model.location)})
                  ,_1: A2($Effects.map,Login,fx)};
         default: var newLocation = $LocationLinks.update(_p5._0);
           var _p10 = newLocation;
           if (_p10 === "logout") {
                 return init;
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{location: newLocation}),_1: $Effects.none};
              }}
   });
...
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var saveToDB = Elm.Native.Port.make(_elm).outboundSignal("saveToDB",
   function (v) {
      return {endDate: v.endDate
             ,startDate: v.startDate
             ,ticker: v.ticker
             ,y: v.y
             ,source: v.source
             ,frequency: v.frequency
             ,newData: Elm.Native.List.make(_elm).toArray(v.newData).map(function (v) {    return [v._0,v._1];})};
   },
   $Forms$AnalysisForm.saveToDBMailBox.signal);
   ...
   $Forms$AnalysisForm.sendToPlotMailBox.signal);
   var registerResponse = Elm.Native.Port.make(_elm).inboundSignal("registerResponse",
   "Forms.RegisterForm.ResponseMessage",
   function (v) {
      return typeof v === "object" && "response" in v && "token" in v ? {_: {}
                                                                        ,response: typeof v.response === "string" || typeof v.response === "object" && v.response instanceof String ? v.response : _U.badPort("a string",
                                                                        v.response)
                                                                        ,token: typeof v.token === "string" || typeof v.token === "object" && v.token instanceof String ? v.token : _U.badPort("a string",
                                                                        v.token)} : _U.badPort("an object with fields `response`, `token`",v);
   });
   var incomingRegisterActions = A2($Signal.map,$Router.Register,A2($Signal.map,$Forms$RegisterForm.Response,registerResponse));
   var registerRequest = Elm.Native.Port.make(_elm).outboundSignal("registerRequest",
   function (v) {
      return {username: v.username,fullname: v.fullname,password: v.password};
   },
   $Forms$RegisterForm.registerRequestMailBox.signal);
   var loginResponse = Elm.Native.Port.make(_elm).inboundSignal("loginResponse",
   "Forms.LoginForm.ResponseMessage",
   function (v) {
      return typeof v === "object" && "response" in v && "token" in v ? {_: {}
                                                                        ,response: typeof v.response === "string" || typeof v.response === "object" && v.response instanceof String ? v.response : _U.badPort("a string",
                                                                        v.response)
   ...
   var incomingLoginActions = A2($Signal.map,$Router.Login,A2($Signal.map,$Forms$LoginForm.Response,loginResponse));
   var loginRequest = Elm.Native.Port.make(_elm).outboundSignal("loginRequest",
   function (v) {
      return {username: v.username,password: v.password};
   },
   $Forms$LoginForm.loginRequestMailBox.signal);
